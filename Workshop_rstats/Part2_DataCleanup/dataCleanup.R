...
# Someone [your boss, a client, the governor - anyone] gives you a csv table
...
system.time(birds <- fread("/Users/tcormier/Documents/misc_projects/foss4g2017_workshop/data/ebd_NE_4spp_workshopData.txt", sep=" "))
system.time(birds2 <- read.table("/Users/tcormier/Documents/misc_projects/foss4g2017_workshop/data/ebd_NE_4spp_workshopData.txt", stringsAsFactors = F, header = T))
...
# Ok, we see a geo coordinates, let's plot them quick and dirty just to get an idea of
# the data:
...
# Ohio is the culprit (note the NA, and we'll deal with that a bit later!)
...
# like convert from a regular date to julien day), we'll convert that field to a date field.
...
write.table(birds, "/Users/tcormier/Documents/misc_projects/foss4g2017_workshop/data/ebd_NE_4spp_workshopData_dataCleanup.txt", row.names=F)
# or
fwrite(birds, "/Users/tcormier/Documents/misc_projects/foss4g2017_workshop/data/ebd_NE_4spp_workshopData_dataCleanup.txt", sep=" ") # untested
